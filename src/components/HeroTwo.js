                ...
                <div className="container relative z-1">
                    ...
                    <div className="flex justify-center text-center relative">
                        <div className="relative">
                            <img src="/images/hero/1.png" className="max-w-lg" alt="img" />
                            ...
                            <div className="absolute top-56 ltr:md:-left-5 ltr:left-24 rtl:md:-right-5 rtl:right-24 p-4 rounded-lg shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900 m-3 w-44 text-center">
                                <h6 className="font-semibold">{userData && userData.timeline[4].jobTitle}</h6>
                                <h6 className="text-sm text-slate-400 mt-1">({userData && userData.timeline[4].startDate.substring(0, 4)} - {userData && userData.timeline[4].endDate.substring(0, 4)})</h6>
                            </div>
                            ...
                            <div className="absolute bottom-20 ltr:md:-right-5 ltr:right-24 rtl:md:-left-5 rtl:left-24 p-4 rounded-lg shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900 m-3 w-44 text-center">
                                <h6 className="font-semibold">{userData && userData.timeline[2].jobTitle}</h6>
                                <h6 className="text-sm text-slate-400 mt-1">({userData && userData.timeline[2].startDate.substring(0, 4)} - {userData && userData.timeline[2].endDate.substring(0, 4)})</h6>
                            </div>
